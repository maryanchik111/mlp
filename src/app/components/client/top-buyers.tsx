...
export default function TopBuyers({ limit = 5 }: TopBuyersProps) {
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-900 flex items-center gap-2">🏆 Топ покупці</h2>
  ...
  if (buyers.length === 0) {
    return (
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-900 flex items-center gap-2">🏆 Топ покупці</h2>
          <p className="text-gray-600 text-sm">Поки що немає даних.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 flex items-center gap-2">🏆 Топ покупці</h2>
        <ol className="space-y-3">
          {buyers.map((u, idx) => {
            ...
            return (
              <li
                key={u.uid}
                className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-shadow"
              >
