      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-4 border-purple-200">
          ...
          <div className="prose prose-purple max-w-none space-y-6 text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold text-pink-700 mb-3">🌍 Індивідуальні замовлення з-за кордону</h2>
              <div className="bg-pink-50 border-l-4 border-pink-400 p-4 rounded mb-4">
                <p className="mb-2"><strong>Товар доставляється під індивідуальне замовлення з-за кордону після оплати.</strong></p>
                <p className="mb-2">Повернення товару належної якості не здійснюється.</p>
                <p>У разі браку або невідповідності — вирішуємо питання обміну або повернення коштів.</p>
              </div>
              <div className="text-gray-700 text-sm space-y-2">
                <p>Якщо ви приймаєте замовлення та оплату, а потім спеціально під цього клієнта замовляєте фігурку з-за кордону — повернення товару належної якості можна не приймати, якщо:</p>
                <ul className="list-disc pl-6">
                  <li>Товар не був у вас в наявності</li>
                  <li>Замовляється після оплати або передплати</li>
                  <li>У листуванні чи описі чітко зазначено, що це індивідуальне замовлення, повернення неможливе, бо імпортується спеціально для клієнта, є терміни доставки і попередження про ризики</li>
                </ul>
                <p>У такому випадку це вважається індивідуальним замовленням, а не звичайною купівлею з полиці.</p>
              </div>
            </section>
